...
def write():
    ...
    streamlit.write("Check it out on [Github!](https://github.com/Pliploop/NLP_Bulk_labelling_app)")
    streamlit.write("My [Linkedin](https://www.linkedin.com/in/julien-guinot/)")
