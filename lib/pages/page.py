...
def write():
    ...
    streamlit.write("Github repo [link](https://github.com/Pliploop/NLP_Bulk_labelling_app)")
    streamlit.write("My Linkedin [link](https://www.linkedin.com/in/julien-guinot/)")
